...
const ARRAY_DEFAULT = 'https://app.array.io/tokenlists/default.json'
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [NFTX_LIST, YEARN_LIST, GEMINI_LIST, ARRAY_DEFAULT]
