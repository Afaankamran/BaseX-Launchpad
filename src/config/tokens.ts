import { WETH9, Token, ChainId, BASEX_ADDRESS, WNATIVE_ADDRESS, WETH9_ADDRESS } from "@devdot/basex-sdk";
// import { WETH9 } from "@/sdk/constants/tokens";
...
export const ARBITRUM: { [key: string]: Token } = {
  ...
  MAY: new Token(ChainId.ARBITRUM, '0xF9DF075716B2D9B95616341DC6bC64c85e56645c', 18, '$MAY', 'May'),
  BASEX: new Token(ChainId.ARBITRUM, '0x164731cd270daa4a94bc70761e53320e48367b8b', 18, 'BASEX', 'BaseX'),
}
export const ARBITRUM_TESTNET: { [key: string]: Token } = {
  USDC: new Token(ChainId.ARBITRUM_TESTNET, '0x179522635726710Dd7D2035a81d856de4Aa7836c', 6, 'USDC', 'USD Coin'),
}
...
export const MATIC: { [key: string]: Token } = {
  ...
  BASEX: new Token(ChainId.MATIC, '0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a', 18, 'BASEX', 'SushiToken'),
...
export const AVALANCHE_TESTNET: { [key: string]: Token } = {
  USDC: new Token(ChainId.AVALANCHE_TESTNET, '0x5425890298aed601595a70AB815c96711a31Bc65', 6, 'USDC', 'USD Coin'),
}
export const BASE_SEPOLIA_TESTNET: { [key: string]: Token } = {
  USDC: new Token(ChainId.BaseSepolia, '0xf08a50178dfcde18524640ea6618a1f965821715', 6, 'USDC', 'USD Coin'),
  BASEX: new Token(ChainId.BaseSepolia, BASEX_ADDRESS[ChainId.BaseSepolia], 18, 'BSX', 'BASX TOKEN'),
}

// Default Avalanche chain tokens
export const array = new Token(ChainId.MAINNET, '0xa1faa113cbE53436Df28FF0aEe54275c13B40975', 18, 'baseX', 'BasexToken')
...
// BASEX
export const BASEX: ChainTokenMap = {
  [ChainId.AVALANCHE_TESTNET]: new Token(
    ChainId.AVALANCHE_TESTNET,
    '0x10917655c904316df1d166512e1dd3f5e41d9d51',
    18,
    'BASEX',
    'BaseX'
  ),

  // [ChainId.MAINNET]: new Token(ChainId.MAINNET, BASEX_ADDRESS[ChainId.MAINNET], 18, 'BASEX', 'SushiToken'),

  // [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, '0xc33Db20b6ffC3ECAA7373a663BCc9691EF04B49d', 18, 'BASEX', 'array'),
  // [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, BASEX_ADDRESS[ChainId.GÖRLI], 18, 'BASEX', 'SushiToken'),
  // [ChainId.KOVAN]: new Token(ChainId.KOVAN, BASEX_ADDRESS[ChainId.KOVAN], 18, 'BASEX', 'SushiToken'),
  // [ChainId.MATIC]: new Token(ChainId.MATIC, BASEX_ADDRESS[ChainId.MATIC], 18, 'BASEX', 'SushiToken'),
  // [ChainId.FANTOM]: new Token(ChainId.FANTOM, BASEX_ADDRESS[ChainId.FANTOM], 18, 'BASEX', 'SushiToken'),
  // [ChainId.XDAI]: new Token(ChainId.XDAI, BASEX_ADDRESS[ChainId.XDAI], 18, 'BASEX', 'SushiToken'),
  // [ChainId.BSC]: new Token(ChainId.BSC, BASEX_ADDRESS[ChainId.BSC], 18, 'BASEX', 'SushiToken'),
  [ChainId.ARBITRUM]: new Token(ChainId.ARBITRUM, BASEX_ADDRESS[ChainId.ARBITRUM], 18, 'BASEX', 'BASEX'),
  [ChainId.ARBITRUM_TESTNET]: new Token(ChainId.ARBITRUM_TESTNET, BASEX_ADDRESS[ChainId.ARBITRUM_TESTNET], 18, 'BASEX', 'BASEX'), // goerli-arbitrum
  [ChainId.BaseSepolia]: new Token(ChainId.BaseSepolia, BASEX_ADDRESS[ChainId.BaseSepolia], 18, 'BASEX', 'BASEX'), // goerli-arbitrum
  // [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, BASEX_ADDRESS[ChainId.AVALANCHE], 18, 'BASEX', 'SushiToken'),
  // [ChainId.OKEX]: new Token(ChainId.OKEX, BASEX_ADDRESS[ChainId.OKEX], 18, 'BASEX', 'SushiToken'),
  // [ChainId.HARMONY]: new Token(ChainId.HARMONY, BASEX_ADDRESS[ChainId.HARMONY], 18, 'BASEX', 'SushiToken'),
  // [ChainId.HECO]: new Token(ChainId.HECO, BASEX_ADDRESS[ChainId.HECO], 18, 'BASEX', 'SushiToken'),
}
export const ARRAY: ChainTokenMap = {
  [ChainId.ARBITRUM]: new Token(ChainId.ARBITRUM, BASEX_ADDRESS[ChainId.ARBITRUM], 18, 'BASEX', 'BASEX'),
  [ChainId.BaseSepolia]: new Token(ChainId.BaseSepolia, BASEX_ADDRESS[ChainId.BaseSepolia], 18, 'BSX', 'BASX TOKEN'),
}
...
export const WETH9_EXTENDED: { [chainId: number]: Token } = {
  ...
  [ChainId.ARBITRUM_TESTNET]: new Token(
    ...
    WETH9_ADDRESS[ChainId.ARBITRUM_TESTNET], // goerli-arbitrum
    18,
    'WETH9',
    'Wrapped Ether'
  ),
  ...
  [ChainId.BaseSepolia]: new Token(
    ChainId.BaseSepolia,
    WETH9[ChainId.BaseSepolia].address,
    18,
    'WETH',
    'Wrapped Ether'
  ),
