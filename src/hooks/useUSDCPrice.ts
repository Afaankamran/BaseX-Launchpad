import { ChainId, Currency, CurrencyAmount, Price, Token, USDC } from '@devdot/basex-sdk'
...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [ChainId.BaseSepolia]: CurrencyAmount.fromRawAmount(USDC[ChainId.BaseSepolia], 100_000e6),
