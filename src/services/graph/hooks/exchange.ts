...
export function useMayPrice(variables = undefined, swrConfig: SWRConfiguration = undefined) {
  const { data } = useSWR(['mayPrice', JSON.stringify(variables)], () => getMayPrice(variables), swrConfig)
  return data
}
