...
export const BLOCKS = {
  [ChainId.ARBITRUM_TESTNET]: 'cowri/arbitrum-goerli-blocks',
  [ChainId.AVALANCHE_TESTNET]: 'gvladika/avalanche-blocks',
  [ChainId.AVALANCHE]: 'blackbullswap/avalanche-blocks',
  [ChainId.ARBITRUM]: 'sushiswap/arbitrum-blocks', // TODO: need to update the graph
  [ChainId.BaseSepolia]: 'sushiswap/base-blocks', // TODO: need to update the graph
  // [ChainId.ZKSYNC]: 'https://api.zksync.io/api/v0.1/blocks', // zach: tried to use it to get block time but not working
  [ChainId.MAINNET]: 'blocklytics/ethereum-blocks',
  [ChainId.ROPSTEN]: 'blocklytics/ropsten-blocks',
  ...
  [ChainId.MOONBEAM]: 'v-van/moonbeam-blocks',
  [ChainId.RINKEBY]: 'digitalnativeinc/rinkeby-blocks',
  // [ChainId.AVALANCHE_TESTNET]: 'klemah/fuji-blocks',
