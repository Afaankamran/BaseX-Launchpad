...
import { Currency, Percent, TradeType, Trade as V2Trade } from '@devdot/basex-sdk'
  ...
  return (
    <div className="grid gap-4">
      <div className="grid gap-2">
        ...
        <div className="ml-3 mr-4 min-w-[24px]">
          <ArrowDown size={24} />
        </div>
        <div className="flex items-center justify-between">
          <div className="flex items-start flex-col gap-3">
            ...
            <div
              className={`overflow-ellipsis w-[220px] overflow-hidden font-bold text-2xl ${priceImpactSeverity > 2 ? 'text-red' : 'text-high-emphesis'
                }`}
            >
