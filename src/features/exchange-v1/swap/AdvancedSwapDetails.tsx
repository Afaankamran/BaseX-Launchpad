import { ChainId, Currency, CurrencyAmount, Ether, Percent, TradeType, Trade as V2Trade } from '@devdot/basex-sdk'
    ...
    <div className="flex flex-col space-y-2">
      <div className="flex flex-row items-center justify-between">
        <span className="flex items-center">
          <div className="text-sm ">{i18n._(t`Route`)}</div>
      ...
      <RowBetween>
        <RowFixed>
          ...
          <QuestionHelper
            text={i18n._(t`A portion of each trade (0.50%) goes to liquidity providers as a protocol incentive.`)}
          />
        </RowFixed>
        <div className="text-sm font-bold text-high-emphesis">
          {realizedLPFee
      ...
      <RowBetween>
        <RowFixed>
          <div className="text-sm ">{i18n._(t`BaseX Fee`)}</div>
          <QuestionHelper text={i18n._(t`A portion of each trade (0.05%) goes to BaseX.`)} />
        </RowFixed>
        <div className="text-sm font-bold text-high-emphesis">
      ...
      <RowBetween>
        <RowFixed>
          <div className="text-sm ">{i18n._(t`Slippage tolerance`)}</div>
