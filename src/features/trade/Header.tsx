import { ChainId, Currency, Percent } from '@devdot/basex-sdk'
...
const ExchangeHeader: FC<ExchangeHeaderProps> = ({ input, output, allowedSlippage }) => {
  ...
  return (
    <div className="flex items-center justify-between pt-4 px-4  border-b border-border-color">
      <div className="grid grid-cols-2 rounded   h-[56px] ">
        <div className="flex justify-center items-center cursor-pointer  px-0 ">
          <NavLink
            activeClassName="font-bold pb-[3px]  active_navlink "
            href={{
              pathname: '/swap',
          ...
          >
            <div className={' '}>
              <div className="bg-dark-900 py-[14px]">
                <a className="flex font-bold items-center justify-center text-base font-medium text-center  text-secondary cursor_pointer active_navlink_text">
                  {i18n._(t`Swap`)}
                </a>
              </div>
            </div>
        ...
        <div className="flex justify-center items-center cursor-pointer   ml-8 px-3">
          <NavLink
            activeClassName="font-bold pb-[3px] active_navlink"
