            ...
            >
                ...
                {farm.pair.type === PairType.SWAP && (
                  <>
                    <Typography variant="sm">
                      ...
                      {i18n._(t`) to receive BaseX LP tokens.`)}
                    </Typography>
                  </>
                )}
              ...
              <div className="flex flex-col space-y-2 md:pr-6">
                ...
                {farm.pair.type === PairType.SWAP && (
                  <Typography variant="sm">
                    {i18n._(
                      t`Harvest rewards and unstake your BaseX LP tokens at any time. You can then remove your liquidity to receive your base investment tokens back in your wallet.`
                    )}
                  </Typography>
                )}
                {farm.pair.type === PairType.KASHI && (
