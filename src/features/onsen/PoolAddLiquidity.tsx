...
import { Currency, CurrencyAmount, currencyEquals, NATIVE, Percent, WNATIVE } from '@devdot/basex-sdk'
...
const PoolDeposit = ({ currencyA, currencyB }) => {
  ...
  return (
    <div>
      ...
      />
      <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-5 justify-between w-full">
