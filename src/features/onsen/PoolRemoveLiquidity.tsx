...
import { ChainId, currencyEquals, NATIVE, Percent, WNATIVE, ZERO } from '@devdot/basex-sdk'
    ...
    <div>
      ...
      <div className="flex flex-col space-y-4">
        ...
        {userLiquidity?.equalTo(ZERO) && (
          <Alert
            message={i18n._(
              t`Note: If your BaseX LP is staked, you cannot remove your liquidity. You must unstake first.`
            )}
            className="mb-4"
            type="information"
          />
