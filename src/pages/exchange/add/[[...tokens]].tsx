...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from '@devdot/basex-sdk'
...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | BaseX</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the BaseX AMM to enable gas optimized and low slippage trades across countless networks"
        />
      </Head>

      <Container id="add-liquidity-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="3xl">
        ...
        <DoubleGlowShadow>
          <div
            className="p-4 space-y-4 rounded-[15px] border border-border-color bg-dark-900 w-[90vw] max-w-3xl mx-auto "
            style={{ zIndex: 1 }}
          >
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div>
                ...
                <AutoColumn className="py-[1.5rem] flex justify-center items-center">
