import { Currency, CurrencyAmount, Ether, JSBI, NATIVE, Token } from '@devdot/basex-sdk'
...
export default function PoolFinder() {
  ...
  return (
    <Container id="find-pool-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>{i18n._(t`Find Pool`)} | BaseX</title>
      ...
      <Alert
        ...
        type="information"
      />
      <div className="relative p-4 space-y-4 rounded-[15px] border border-border-color bg-dark-900 shadow-liquidity">
        <AutoColumn gap={'md'}>
          <CurrencySelectPanel
            currency={currency0}
