...
import { ChainId, Currency, NATIVE, Percent, WNATIVE, WNATIVE_ADDRESS } from '@devdot/basex-sdk'
...
export default function Remove() {
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | BaseX</title>
        <meta key="description" name="description" content="Remove liquidity from the Array AMM" />
      </Head>
      ...
      <DoubleGlowShadow>
        <div className="p-4 space-y-4 rounded-[15px] bg-dark-900  border-border-color mx-4" style={{ zIndex: 1 }}>
          {/* <AddRemoveTabs
          creating={false}
          adding={false}
