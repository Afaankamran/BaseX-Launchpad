...
import PairChart from '../../../PriceChart'
...
export default function Swap() {
  ...
  const importTokensNotInDefault =
    ...
    urlLoadedTokens.filter((token: Token) => {
      return (
        !Boolean(token.address in defaultTokens) &&
        !Boolean(
          Object.values(ARRAY)
            .map((token) => getAddress(token.address))
            .includes(getAddress(token.address))
        )
      )
    })
  ...
  const [_, pair] = useV2Pair(currencies.INPUT ?? undefined, currencies.OUTPUT ?? undefined)

  const ChartSupported = chainId && featureEnabled(Feature.PRICE_CHART, chainId)
  return (
    <div className='w-full flex justify-center items-center'>
      <Container
        id="swap-page"
        className={
          ChartSupported ? 'container px-0 mx-auto sm:pb-10 sm:pt-10' : 'py-4 md:py-8 lg:py-12'
        }
      >
        <Head>
        ...
        />
        <DoubleGlowShadow>
          <div className="grid grid-cols-1 gap-2 rounded z-4  w-[90vw] max-w-3xl mx-auto">
            <div className="col-span-1  rounded-[15px] bg-light-glass bg-dark-900 border border-border-color">
              <SwapHeader
              ...
              <div className="p-6">
                ...
                />
                <AutoColumn justify="center" className="py-3 justify-center my-5">
                  <div
                    className={classNames(
                      isExpertMode ? 'justify-center' : 'flex-center',
                  ...
                  >
                    ...
                    >
                      <div className="rounded-full bg-linear-gradient  p-3px">
                        <div
                ...
                <div>
                  <CurrencyInputPanel
                    ...
                    label={
                      independentField === Field.INPUT && !showWrap ? i18n._(t`Swap To (appro.):`) : i18n._(t`Swap To:`)
                    }
                    showMaxButton={false}
                    hideBalance={false}
                  ...
                  />
                  {Boolean(trade) && (
                    <div className="p-1  mt-0 cursor-pointer rounded-b-md bg-dark-800">
                      <TradePrice
            ...
            <div className="p-5 rounded bg-dark-800">
              ...
              <BottomGrouping>
                {swapIsUnsupported ? (
                  ...
                  <Web3Connect size="lg" color="blue" className="w-full py-5 font-bold text-[20px]" />
                ) : showWrap ? (
        ...
        />
            ...
            <div className={'grid grid-cols-1 space-y-4 lg:space-x-4 '}>
              {ChartSupported && (
                <div className="flex flex-col col-span-1 p-6 mt-6 mb-20 rounded-lg sm:mb-0 bg-light-glass sm:bg-dark-900">
                  <PairChart pair={pair} currency0={currencies.INPUT} currency1={currencies.OUTPUT} color="#fff" />
                </div>
              )}
            </div>
          </div>
