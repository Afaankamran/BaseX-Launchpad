import { ChainId, CurrencyAmount, JSBI, NATIVE, Pair } from '@devdot/basex-sdk'
...
import { Currency } from '@devdot/basex-sdk'
...
export default function Pool() {
  ...
  const migrationSupported = false
  return (
    <Container id="pool-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Pool | BaseX</title>
        <meta
          key="description"
          name="description"
          content="BaseX liquidity pools are markets for trades between the two tokens, you can provide these tokens and become a liquidity provider to earn 0.25% of fees from trades."
        />
      </Head>
      ...
      <div className="p-4 space-y-4 rounded-[15px] border border-border-color bg-dark-900 mx-5">
