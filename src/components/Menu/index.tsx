...
const items = (i18n: I18n) => [
  {
    name: i18n._(t`Docs`),
    description: i18n._(t`Documentation for users of BaseX.`),
    href: 'https://docs.array.com',
  },
  {
    name: i18n._(t`Dev`),
    description: i18n._(t`Documentation for developers of BaseX.`),
    href: 'https://dev.sushi.com',
  },
  {
    name: i18n._(t`Open Source`),
    description: i18n._(t`BaseX is a supporter of Open Source.`),
