  ...
  return (
    <div
      ...
      className={classNames(
        ...
        'rounded flex flex-col justify-center items-center sm:justify-start sm:items-start sm:flex-row  space-y-3 sm:space-y-0 p-4'
      )}
      key={listUrl}
    >
      <div className="flex flex-col sm:flex-row justify-center items-center sm:justify-start space-x-0 sm:space-x-3 flex-auto ">
        <div>
          {list.logoURI ? (
        ...
        <div>
          ...
          <div className="relative flex justify-center sm:justify-start flex-row">
