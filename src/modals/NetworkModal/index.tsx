...
export const SUPPORTED_NETWORKS: {
  ...
  [ChainId.BaseSepolia]: {
    ...
    rpcUrls: ['https://base-sepolia.g.alchemy.com/v2/ALvOjqNuo_nW4WgULKKlJJeQXsQYiZOn'],
    blockExplorerUrls: ['https://base-sepolia.g.alchemy.com/v2/ALvOjqNuo_nW4WgULKKlJJeQXsQYiZOn'],
  },
  [ChainId.FANTOM]: {
    chainId: '0xfa',
    chainName: 'Fantom',
  ...
  [ChainId.MOONBEAM_TESTNET]: {
    chainId: '0x507',
    chainName: 'Monnbase Alpha Testnet',
    nativeCurrency: {
      name: 'Moonbase Alpha',
      symbol: 'DEV',
      decimals: 18,
  ...
  return (
    <Modal isOpen={networkModalOpen} onDismiss={toggleNetworkModal} maxWidth={672}>
      ...
      <div className="mb-6 text-lg text-primary">
        You are currently browsing <span className="font-bold text-pink">BASEX</span>
            ...
            <button
              ...
              onClick={() => {
                ...
                if (key === ChainId.MAINNET) {
                  library?.send('wallet_switchAvalancheChain', [{ chainId: '0x1' }, account])
                } else {
                  library?.send('wallet_addAvalancheChain', [params, account])
                }
              }}
