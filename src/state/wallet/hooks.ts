...
import { Currency, CurrencyAmount, NATIVE, Token, JSBI } from '@devdot/basex-sdk'; // commented to use local NATIVE to be able to add zkSync
import { useAllTokens } from '@/hooks/Tokens';
...
export function useETHBalances(uncheckedAddresses?: (string | undefined)[]): {
  ...
  console.log({ results, multicallContract, addresses })
...
export const serializeBalancesMap = (
  mapping: Record<string, CurrencyAmount<Token>>,
): string => {
