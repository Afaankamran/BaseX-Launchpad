...
import { ChainId, FACTORY_ADDRESS, JSBI, Pair, Percent, Token, computePairAddress } from '@devdot/basex-sdk'
import {
  SerializedPair,
  SerializedToken,
  addSerializedPair,
...
export function useUserSlippageTolerance(): Percent | 'auto' {
  ...
  return useMemo(
    () => (userSlippageTolerance && userSlippageTolerance === 'auto' ? 'auto' : new Percent(userSlippageTolerance, 10_000)),
