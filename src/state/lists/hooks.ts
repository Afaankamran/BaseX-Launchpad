...
import DEFAULT_TOKEN_LIST from '@array.inc/default-token-list'
...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    421613: { ...map1[421613], ...map2[421613] }, // arbitrum testnet
    ...
    [ChainId.BaseSepolia]: { ...map1[ChainId.BaseSepolia], ...map2[ChainId.BaseSepolia] }, // moonbeam
  }
}
